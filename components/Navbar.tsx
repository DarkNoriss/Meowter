...
export const Navbar = () => {
  ...
  return (
    <header>
      <div className='border-white-smoll flex h-screen w-72 flex-col justify-between !border-y-0 !border-l-0 pl-2 pr-7'>
        <div className='fixed top-0 mt-2 flex h-full flex-col justify-between'>
          <div className=''>
            <Link
              href='/'
